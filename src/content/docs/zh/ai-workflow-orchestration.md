...
| 框架 | 类型 | 语言 | 学习曲线 | 可视化 | 适用场景 |
|------|------|------|---------|--------|---------|
| **LangChain** | 代码库 | Python/JS | 中等 | ❌ | 开发者定制 |
| **LlamaIndex** | 代码库 | Python | 中等 | ❌ | RAG 场景 |
| **Dify** | 低代码平台 | Web UI | 简单 | ✅ | 快速搭建 |
| **Flowise** | 低代码平台 | Web UI | 简单 | ✅ | 可视化编排 |
| **AutoGen** | 多 Agent 框架 | Python | 较陡 | ❌ | 多 Agent 协作 |
| **CrewAI** | 角色化框架 | Python | 中等 | ❌ | 角色模拟 |
