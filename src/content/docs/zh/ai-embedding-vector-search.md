...
| 模型 | 维度 | 最大长度 | 语言 | 特点 |
|------|------|---------|------|------|
| **text-embedding-3-large** | 3072 | 8191 | 多语言 | OpenAI，效果最好 |
| **text-embedding-3-small** | 1536 | 8191 | 多语言 | OpenAI，性价比高 |
| **bge-large-zh** | 1024 | 512 | 中文优化 | 中文场景首选 |
| **m3e-base** | 768 | 512 | 中文优化 | 中文语义理解好 |
| **multilingual-e5** | 1024 | 512 | 多语言 | 微软，多语言支持好 |
...
| 数据库 | 类型 | 特点 | 适用场景 |
|--------|------|------|---------|
| **Chroma** | 嵌入式 | 轻量、易用、Python 原生 | 原型开发、小规模 |
| **Milvus** | 分布式 | 高性能、可扩展 | 生产环境、大规模 |
| **Qdrant** | 分布式 | 过滤能力强、API 友好 | 生产环境 |
| **Pinecone** | 托管服务 | 免运维、自动扩展 | 快速上线 |
| **Weaviate** | 分布式 | 支持混合搜索、GraphQL | 复杂查询 |
| **FAISS** | 库 | Facebook 开源、速度快 | 嵌入到应用中 |
